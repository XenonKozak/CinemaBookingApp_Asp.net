...
- **Azure AI Services (Text Analytics)**: Zaawansowana analiza tekstu oparta o sztuczną inteligencję Microsoft Azure. Służy do automatycznego badania nastroju (Sentiment Analysis) recenzji filmów wprowadzanych przez użytkowników, co pozwala na automatyczną ocenę opinii (pozytywna, neutralna, negatywna) i prezentację tych statystyk.
